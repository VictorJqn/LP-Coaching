  ...
  const benefits = [
    {
      ...
      icon: (
        <Heart size={32} className="stroke-artistic-sand" strokeWidth={1.5} />
      ),
    },
    {
      ...
      icon: (
        <Award size={32} className="stroke-artistic-sand" strokeWidth={1.5} />
      ),
    },
    {
      ...
      icon: (
        <Clock size={32} className="stroke-artistic-sand" strokeWidth={1.5} />
      ),
    },
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16 reveal">
          <div className="inline-flex items-center justify-center mb-4">
            ...
            <span className="inline-block bg-gradient-to-r from-artistic-navy to-artistic-orange text-artistic-sand font-semibold mx-4 px-4 py-1.5 rounded-sm transform rotate-1">
              MES AVANTAGES
            </span>
            <span className="w-12 h-1 bg-artistic-orange"></span>
          </div>
          ...
          <p className="section-subtitle text-xl max-w-2xl mx-auto">
            Un accompagnement sur mesure pour atteindre vos objectifs de manière
            durable
          </p>
        </div>
